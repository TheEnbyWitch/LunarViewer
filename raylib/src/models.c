...
void DrawMeshInstanced(Mesh mesh, Material material, Matrix *transforms, int instances)
{
    ...
    if (material.shader.locs[SHADER_LOC_MATRIX_NORMAL] != -1) rlSetUniformMatrix(material.shader.locs[SHADER_LOC_MATRIX_NORMAL], MatrixTranspose(MatrixInvert(transforms[0])));
    //-----------------------------------------------------
